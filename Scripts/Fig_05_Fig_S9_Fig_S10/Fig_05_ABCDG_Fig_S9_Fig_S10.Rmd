...
# pdf(file = paste(figures_folder, '/Fig_05/Panel_A.pdf', sep = ''), 
#     width = 7.3307087, height = 2.95276)
# ComplexHeatmap::draw(HMap_vangalen, heatmap_legend_side = "bottom", annotation_legend_side = "bottom")
# invisible(dev.off())
...
HMap_vangalen <- Heatmap(VanGalen_celltype_modules_scores, name = 'ssGSEA Score', column_split = RF_cluster_metadata$RF_Cluster, top_annotation = col_anno, col = col_heatmap_guide, rect_gp = gpar(col = "black", lwd = 0.05), column_title_gp = gpar(fontsize=11, fontface='bold'), row_names_gp = gpar(fontsize=10), cluster_rows = F, cluster_column_slices = F, column_names_gp = gpar(fontsize=10), show_heatmap_legend = T, heatmap_legend_param = list(legend_direction = "horizontal", legend_width = unit(2, "cm")), row_names_side = 'right')

# Open a new PNG device
png(filename = paste(figures_folder, '/Other/Fig_5_Panel_A_with_legend.png', sep = ''), units = 'cm', width = 18.62, height = 7.5, res = 300)
ComplexHeatmap::draw(HMap_vangalen, heatmap_legend_side = "bottom", annotation_legend_side = "bottom")
invisible(dev.off())

# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Other/Fig_5_Panel_A_with_legend.pdf', sep = ''), 
#     width = 7.3307087, height = 2.95276)
# ComplexHeatmap::draw(HMap_vangalen, heatmap_legend_side = "bottom", annotation_legend_side = "bottom")
# invisible(dev.off())
```
...
# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Fig_05/Panel_B.pdf', sep = ''), 
#     width = 6.29921, height = 2.95276)
# draw(HMap_WGCNA, heatmap_legend_side = "bottom", annotation_legend_side = "bottom")
# invisible(dev.off())
...
HMap_WGCNA <- Heatmap(WGCNA_modules_scores, name = 'ssGSEA Score', column_split = RF_cluster_metadata$RF_Cluster, top_annotation = col_anno, col = col_heatmap_guide, rect_gp = gpar(col = "black", lwd = 0.05), column_title_gp = gpar(fontsize=11, fontface='bold'), row_names_gp = gpar(fontsize=10), cluster_rows = F, cluster_column_slices = F, column_names_gp = gpar(fontsize=10), show_heatmap_legend = T, heatmap_legend_param = list(legend_direction = "horizontal", legend_height = unit(5, "cm")), row_names_side = 'right')

# Open a new PNG device
png(filename = paste(figures_folder, '/Other/Fig_5_Panel_B_with_legend.png', sep = ''), 
    width = 6.29921, height = 2.95276, res = 300)
draw(HMap_WGCNA, heatmap_legend_side = "bottom", annotation_legend_side = "bottom")
invisible(dev.off())

# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Other/Fig_5_Panel_B_with_legend.pdf', sep = ''), 
#     width = 6.29921, height = 2.95276)
# draw(HMap_WGCNA, heatmap_legend_side = "bottom", annotation_legend_side = "bottom")
# invisible(dev.off())
```
...
# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Supplemental/Fig_S9.pdf', sep = ''), 
#     width = 7.559055, height = 4.33071)
# draw(HMap, heatmap_legend_side = "bottom", annotation_legend_side = "bottom")
# invisible(dev.off())
...
HMap <- Heatmap(Velten_celltype_modules_scores, name = 'ssGSEA Score', column_split = Identity$RF_Cluster, top_annotation = col_anno, col = col_heatmap_guide, rect_gp = gpar(col = "black", lwd = 0.05), column_title_gp = gpar(fontsize=11, fontface='bold'), row_split = Module_Identity$Celltype, cluster_rows = F, row_gap = unit(0.05, "cm"), cluster_column_slices = F, row_names_gp = gpar(fontsize=9), row_title_rot = 0, row_title_gp = gpar(fontsize=9, fontface='bold', col=Celltype$Colour), column_names_gp = gpar(fontsize=9), show_heatmap_legend = T, heatmap_legend_param = list(legend_direction = "horizontal", legend_height = unit(5, "cm")), row_names_side = 'right')

# Open a new PNG device
png(filename = paste(figures_folder, '/Other/Fig_S9_with_legend.png', sep = ''), 
    width = 7.559055, height = 4.33071, res = 300)
draw(HMap, heatmap_legend_side = "bottom", annotation_legend_side = "bottom")
invisible(dev.off())

# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Other/Fig_S9_with_legend.pdf', sep = ''), 
#     width = 7.559055, height = 4.33071)
# draw(HMap, heatmap_legend_side = "bottom", annotation_legend_side = "bottom")
# invisible(dev.off())
```
...
png(filename = paste(figures_folder, '/Other/DGE_C1_vs_Control_resAsh.png', sep = ''), units = 'cm', width = 8.58, height = 12.1, res = 300)
...
# Start recording plot to a PNG file
png(filename = paste(figures_folder, '/Other/DGE_C2_vs_Control_resAsh.png', sep = ''), units = 'cm', width = 8.58, height = 12.1, res = 300)
...
png(filename = paste(figures_folder, '/Other/DGE_C1_vs_C2_resAsh.png', sep = ''), units = 'cm', width = 8.58, height = 12.1, res = 300)
...
keyvals <- ifelse(
  genemat_ord$log2FoldChange < 0 & genemat_ord$pvalue < 50e-3, '#415384',
  ifelse(genemat_ord$log2FoldChange > 0 & genemat_ord$pvalue < 50e-3, '#C92A1D',
    '#727272'))
...
# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Fig_05/Panel_C-1.pdf', sep = ''), 
#     width = 4.3, height = 5.5)
# print(plot)
# invisible(dev.off())
```
...
# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Fig_05/Panel_C-2.pdf', sep = ''), 
#     width = 4.3, height = 5.5)
# print(plot)
# invisible(dev.off())
```
...
# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Supplemental/Fig_S10.pdf', sep = ''), 
#     width = 4.3, height = 5.5)
# print(plot)
# invisible(dev.off())
```
...
#            'C1' = Cluster_2_UP$GeneSymbol),
#   output=TRUE,
#   filename = paste(figures_folder, '/Fig_05/Panel_D.pdf', sep = ''),
#   main = '',
#   main.cex = 1.5,
#   main.fontface = "bold",
#   main.fontfamily = "sans",
...
# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Fig_05/Panel_G.pdf', sep = ''), 
#     width = 11.811, height = 5.51181)
# draw(Heatmap_genes, heatmap_legend_side = "bottom", 
#      annotation_legend_side = "bottom")
# invisible(dev.off())
...
# Open a new PNG device
png(filename = paste(figures_folder, '/Other/Fig_5_Panel_G_with_legend.png', sep = ''), 
    width = 11.811, height = 5.51181, res=300)
draw(Heatmap_genes, heatmap_legend_side = "bottom", 
     annotation_legend_side = "bottom")
invisible(dev.off())

# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Other/Fig_5_Panel_G_with_legend.pdf', sep = ''), 
#     width = 11.811, height = 5.51181)
# draw(Heatmap_genes, heatmap_legend_side = "bottom", 
#      annotation_legend_side = "bottom")
# invisible(dev.off())
