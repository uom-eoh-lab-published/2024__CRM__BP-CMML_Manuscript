...
packages_required <- c("escape", "fgsea", "stringr", "dplyr",
                       "ggplot2")
...
```{r}
dir.create(file.path(paste(data_folder, '/RNASeq/InHouse/Pathway_Analysis/BP-CMML_vs_Control', 
...
```{r}
Blast_phase_vs_Control_DEGS <- read.csv(paste(data_folder, '/RNASeq/InHouse/DESeq2/DEGs_Comparisons/BP-CMML_vs_Control/DGE_BP-CMML_vs_Control_ALL_DEGs_LFC_Ashr.csv', sep = ''), row.names = 'X')
...
write.csv(x = fgseaRes_Hallmark, file = paste(data_folder, '/RNASeq/InHouse/Pathway_Analysis/BP-CMML_vs_Control/fGSEA_H_BP-CMML_vs_Control_all.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_Hallmark %>% filter(NES > 0), file = paste(data_folder, '/RNASeq/InHouse/Pathway_Analysis/BP-CMML_vs_Control/fGSEA_H_BP-CMML_vs_Control__Up_in_BP-CMML.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_Hallmark %>% filter(NES < 0), file = paste(data_folder, '/RNASeq/InHouse/Pathway_Analysis/BP-CMML_vs_Control/fGSEA_H_BP-CMML_vs_Control__Up_in_Control.csv', 
                                    sep = ''))
```
...
write.csv(x = fgseaRes_CP, file = paste(data_folder, '/RNASeq/InHouse/Pathway_Analysis/BP-CMML_vs_Control/fGSEA_CP_BP-CMML_vs_Control_all.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_CP %>% filter(NES > 0), file = paste(data_folder, '/RNASeq/InHouse/Pathway_Analysis/BP-CMML_vs_Control/fGSEA_CP_BP-CMML_vs_Control__Up_in_BP-CMML.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_CP %>% filter(NES < 0), file = paste(data_folder, '/RNASeq/InHouse/Pathway_Analysis/BP-CMML_vs_Control/fGSEA_CP_BP-CMML_vs_Control__Up_in_Control.csv', 
                                    sep = ''))
```
...
write.csv(x = fgseaRes_GO_BP, file = paste(data_folder, '/RNASeq/InHouse/Pathway_Analysis/BP-CMML_vs_Control/fGSEA_GO_BP_BP-CMML_vs_Control_all.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_GO_BP %>% filter(NES > 0), file = paste(data_folder, '/RNASeq/InHouse/Pathway_Analysis/BP-CMML_vs_Control/fGSEA_GO_BP_BP-CMML_vs_Control__Up_in_BP-CMML.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_GO_BP %>% filter(NES < 0), file = paste(data_folder, '/RNASeq/InHouse/Pathway_Analysis/BP-CMML_vs_Control/fGSEA_GO_BP_BP-CMML_vs_Control__Up_in_Control.csv', 
                                    sep = ''))
```

## - Pathway plotting

```{r echo=FALSE, fig.align='center', fig.cap='Figure 2G. BP-CMML blasts are transcriptionally heterogenous and characterized by increased quiescence and senescence signatures.', fig.height=4.0708661, fig.pos='H', fig.width=4.527559}
...
```{r echo=FALSE, fig.align='center', fig.cap='Figure 2H', fig.height=2.2333, fig.pos='H', fig.width=3.62}
