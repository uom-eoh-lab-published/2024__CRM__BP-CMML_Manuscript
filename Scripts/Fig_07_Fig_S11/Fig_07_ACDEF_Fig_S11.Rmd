...
# pdf(file = paste(figures_folder, '/Supplemental/Fig_S11.pdf', sep = ''), 
#     width = 11.811, height = 7.87402)
# draw(HMap_BeatAMLdrugs, heatmap_legend_side = "bottom", 
#      annotation_legend_side = "bottom")
# invisible(dev.off())
...
# Save the heatmap as a PNG file
png(filename = paste(figures_folder, '/Other/Fig_S11_with_legend.png', sep = ''), units = "cm", width = 30, height = 20, res = 300)
draw(HMap_BeatAMLdrugs, heatmap_legend_side = "bottom", 
     annotation_legend_side = "bottom")
invisible(dev.off())

# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Other/Fig_S11_with_legend.pdf', sep = ''), 
#     width = 11.811, height = 7.87402)
# draw(HMap_BeatAMLdrugs, heatmap_legend_side = "bottom", 
#      annotation_legend_side = "bottom")
# invisible(dev.off())
...
# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Fig_07/Panel_A.pdf', sep = ''), 
