...
dir.create(paste0(figures_folder, '/Not_Included/ExVivo_Inhibitor_Response_Distributions'), showWarnings = FALSE)
```
...
for (drug in colnames(DrugResponse_classification)) {
  ...
  # Set up PNG output
  png(filename = paste0(figures_folder, '/Not_Included/ExVivo_Inhibitor_Response_Distributions/', drug, '.png'), 
