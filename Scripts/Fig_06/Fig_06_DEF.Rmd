...
For this correlation we also compared healthy donors, so we will load enrichment scores that include those samples.
...
plot + geom_point(data = Cor_df, aes(fill=Cluster), 
...
As above, we will load enrichment scores that include healthy samples.
