---
title: "Figure 02 - Panels CDEF + Fig S4"
output: 
  rmdformats::robobook:
    lightbox: true
    fig_caption: true
...
writeLines(capture.output(sessionInfo()), file.path(script_folder, 'Fig_02_CDEF_Fig_S4_SessionInfo.txt'))
...
# Save the figure as a PNG file
save_image(fig, paste(figures_folder, '/Supplemental/Fig_S4.png', sep = ''), width = 2.5 * 300, height = 2.5 * 300, scale = 2)
```
