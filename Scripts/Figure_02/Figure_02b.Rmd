...
```{r}
Expression_matrix <- read.csv(paste(data_folder, '/Resources/RNASeq/Counts/Processed_counts/Grouped/Tximport_TPM_mat.csv', 
                                    sep = ''), 
                              row.names = 'X')
...
Samples_metadata <- read.csv(paste(data_folder, '/Resources/RNASeq/Metadata/InHouse/Samples_Metadata.csv', sep = ''), row.names = 'Patient.ID')
```

# 3) Filtering expression matrix

```{r}
Unique_genes <- read.table(file = paste(data_folder, '/InHouse/RNASeq/Counts/Processed_counts/List_unique_genes.csv', 
...
```{r}
dir.create(file.path(paste(data_folder, '/InHouse/RNASeq/Pathway_Analysis/Control_vs_BP-CMML', 
...
```{r}
Blast_phase_vs_Control_DEGS <- read.csv(paste(data_folder, '/InHouse/RNASeq/DESeq2/DEGs_Comparisons/Control_vs_BP-CMML/DGE_BP-CMML_vs_Control_ALL_DEGs_LFC_Ashr.csv', sep = ''), row.names = 'X')
...
```{r}
Hallmark_pathways_gmt_file <- paste(data_folder, '/InHouse/RNASeq/Resources/Gene_Pathways/2022__GSEA_MSIGDB__h.all.v2022.1.Hs.symbols.gmt.txt', sep = '')
...
write.csv(x = fgseaRes_Hallmark, file = paste(data_folder, '/InHouse/RNASeq/Pathway_Analysis/Control_vs_BP-CMML/fGSEA_H_BP-CMML_vs_Control_all.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_Hallmark %>% filter(NES > 0), file = paste(data_folder, '/InHouse/RNASeq/Pathway_Analysis/Control_vs_BP-CMML/fGSEA_H_BP-CMML_vs_Control__Up_in_BP-CMML.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_Hallmark %>% filter(NES < 0), file = paste(data_folder, '/InHouse/RNASeq/Pathway_Analysis/Control_vs_BP-CMML/fGSEA_H_BP-CMML_vs_Control__Up_in_Control.csv', 
                                    sep = ''))
```
...
```{r}
CanonicalPathways_gmt_file <- paste(data_folder, '/InHouse/RNASeq/Resources/Gene_Pathways/2022__GSEA_MSIGDB__c2.cp.v2022.1.Hs.symbols.gmt.txt', sep = '')
...
write.csv(x = fgseaRes_CP, file = paste(data_folder, '/InHouse/RNASeq/Pathway_Analysis/Control_vs_BP-CMML/fGSEA_CP_BP-CMML_vs_Control_all.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_CP %>% filter(NES > 0), file = paste(data_folder, '/InHouse/RNASeq/Pathway_Analysis/Control_vs_BP-CMML/fGSEA_CP_BP-CMML_vs_Control__Up_in_BP-CMML.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_CP %>% filter(NES < 0), file = paste(data_folder, '/InHouse/RNASeq/Pathway_Analysis/Control_vs_BP-CMML/fGSEA_CP_BP-CMML_vs_Control__Up_in_Control.csv', 
                                    sep = ''))
```
...
GO_BP_gmt_file <- paste(data_folder, 
                        '/InHouse/RNASeq/Resources/Gene_Pathways/2022__GSEA_MSIGDB__c5.go.bp.v2022.1.Hs.symbols.gmt.txt', sep = '')
...
write.csv(x = fgseaRes_GO_BP, file = paste(data_folder, '/InHouse/RNASeq/Pathway_Analysis/Control_vs_BP-CMML/fGSEA_GO_BP_BP-CMML_vs_Control_all.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_GO_BP %>% filter(NES > 0), file = paste(data_folder, '/InHouse/RNASeq/Pathway_Analysis/Control_vs_BP-CMML/fGSEA_GO_BP_BP-CMML_vs_Control__Up_in_BP-CMML.csv', 
                                    sep = ''))

write.csv(x = fgseaRes_GO_BP %>% filter(NES < 0), file = paste(data_folder, '/InHouse/RNASeq/Pathway_Analysis/Control_vs_BP-CMML/fGSEA_GO_BP_BP-CMML_vs_Control__Up_in_Control.csv', 
                                    sep = ''))
```
...
Quiescence_HSC_gmt_file <- paste(data_folder, 
                        '/InHouse/RNASeq/Resources/Gene_Pathways/2007__Graham_et_al__NormalQuiescent_vs_NormalDividing.gmt', 
                        sep = '')
...
Roy2021_signatures <- read.csv(paste(data_folder, 
                        '/InHouse/RNASeq/Resources/Gene_Pathways/2021__Roy_et_al__cellcycle.csv', 
                        sep = ''))
...
Senescence_gmt_file <- paste(data_folder, 
                        '/InHouse/RNASeq/Resources/Gene_Pathways/2008__Fridman_and_Tainsky__UP_in_Senescencent.gmt', 
                        sep = '')
