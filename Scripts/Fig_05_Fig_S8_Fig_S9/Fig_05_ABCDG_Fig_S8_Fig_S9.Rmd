---
title: "Figure 05 - Panels ABCDEFG + Fig S8 + Fig S9"
output: 
  rmdformats::robobook:
    lightbox: true
    fig_caption: true
...
writeLines(capture.output(sessionInfo()), file.path(script_folder, 'Fig_05_ABCDG_Fig_S8_Fig_S9_SessionInfo.txt'))
...
## - 2017 Velten L. et al Enrichment Scores HeatMap : Fig S8
...
# Open a new PNG device
png(filename = paste(figures_folder, '/Supplemental/Fig_S8.png', sep = ''), units = 'cm', width = 19.2, height = 11, res = 300)
...
# Save the plot as a PNG file
png(filename = paste(figures_folder, '/Supplemental/Fig_S9.png', sep = ''), units = 'in', width = 4.3, height = 5.5, res = 300)
print(plot)
invisible(dev.off())
```
