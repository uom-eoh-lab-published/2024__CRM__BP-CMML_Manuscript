...
packages_required <- c("GENIE3", "doRNG", "stringr", "impute", "GO.db",
...
# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction) - not export as pdf due to the plot having too many vectors making illustrator crash
# # Open a new PNG device for plotting
# png(filename = paste(figures_folder, '/Fig_03/Panel_A.png', sep = ''), units = 'cm', width = 35, height = 17, res = 900)
# 
# # Plot the TOM again, this time saving it to a PNG file
# TOMplot(dissim = log2(disssim_signed), 
#         dendro = dendr, 
...
# pdf(file = paste(figures_folder, '/Fig_03/Panel_B.pdf', sep = ''), width = 13.751969, height = 5.7637795)
# plotDendroAndColors(
#         dendr,
#         gene_significance_colors_short_merged,
#         groupLabels = c("Module color", colnames(model_matrix_short)),
...
# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Fig_03/Panel_C.pdf', sep = ''), width = 8.66142, height = 3.93701)
# draw(Heatmap_trait_cor, heatmap_legend_side = "bottom", 
#      annotation_legend_side = "bottom")
# invisible(dev.off())
```
...
# # We also saved a high dpi copy to be used to assemble a high resolution composite figure for the manuscript (render not included in GitHub repo due to size restriction)
# pdf(file = paste(figures_folder, '/Fig_03/Panel_G.pdf', sep = ''), width = 2.50492126, height = 7.523622)
# print(plot)
# invisible(dev.off())
```
