---
title: "Figure 07 - Panels ACDEF + Fig S10"
output: 
  rmdformats::robobook:
    lightbox: true
    fig_caption: true
...
# 3) Vizome BeatAML drug responses heatmap - K2 : Fig S10
...
png(filename = paste(figures_folder, '/Supplemental/Fig_S10.png', sep = ''), units = "cm", width = 30, height = 20, res = 300)
draw(HMap_BeatAMLdrugs, heatmap_legend_side = "bottom", 
     annotation_legend_side = "bottom")
invisible(dev.off())
```
...
```{r echo=TRUE, fig.align='center', fig.cap='Figure D', fig.pos='H', fig.height=5.51181, fig.width=5.51181}
